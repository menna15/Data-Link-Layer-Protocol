...
void MyMessage_Base::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->ACK_NACK);
}
...
void MyMessage_Base::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->ACK_NACK);
}
...
int MyMessage_Base::getACK_NACK() const
{
    return this->ACK_NACK;
}

void MyMessage_Base::setACK_NACK(int ACK_NACK)
{
    this->ACK_NACK = ACK_NACK;
}
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='T' && strcmp(fieldName, "Trailer")==0) return base+3;
    if (fieldName[0]=='A' && strcmp(fieldName, "ACK_NACK")==0) return base+4;
...
std::string MyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return pp->getTrailer().to_string();
        case 4: return long2string(pp->getACK_NACK());
        default: return "";
    }
}
...
bool MyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 4: pp->setACK_NACK(string2long(value)); return true;
...
void *MyMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    MyMessage_Base *pp = (MyMessage_Base *)object; (void)pp;
    switch (field) {
        case 3: return (void *)(&pp->getTrailer()); break;
        default: return nullptr;
    }
}
